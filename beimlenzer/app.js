/*
  Ferienhaus Beim Lenzer – Booking & UI Script (vanilla JS)
  - Apartments config
...
const DISPLAY_EMAIL = "info@beimlenzer.de"; // Display email
...
const translations = {
  en: {
    ...
    // Hero
    'hero.title': 'Ferienhaus Beim Lenzer',
    'hero.subtitle': 'Family Mayer welcomes you to Schwangau near the King\'s Castles',
  ...
  de: {
    ...
    // Hero
    'hero.title': 'Ferienhaus Beim Lenzer',
    'hero.subtitle': 'Familie Mayer begrüßt Sie in Schwangau bei den Königsschlössern.',
...
const APARTMENTS = [
  {
    id: "saeuling",
    name: "Ferienwohnung \"Säuling\"",
    short: "Sleeps 2-4 · 70 m² · West Balcony",
    pricePerNight: 120,
    ...
    sqm: 70,
    photos: [
      { src: "assets/saeuling/wohnzimmer.jpg", alt: "Säuling – Wohnzimmer mit Smart-TV" },
      { src: "assets/saeuling/kueche.jpg", alt: "Säuling – Separate Küche mit Spülmaschine" },
      { src: "assets/saeuling/esstisch.jpg", alt: "Säuling – Essbereich" },
      { src: "assets/saeuling/schlafzimmer1.jpg", alt: "Säuling – Schlafzimmer 1 mit Boxspringbetten" },
      { src: "assets/saeuling/schlafzimmer2.jpg", alt: "Säuling – Schlafzimmer 2" },
      { src: "assets/saeuling/badezimmer1.jpg", alt: "Säuling – Badezimmer mit Dusche" },
      { src: "assets/saeuling/badezimmer2.jpg", alt: "Säuling – Zusätzliches Bad" },
      { src: "assets/saeuling/aussicht.jpg", alt: "Säuling – Panoramablick vom Westbalkon" },
      { src: "assets/saeuling/grundriss.png", alt: "Säuling – Grundriss" }
    ],
    blockedDates: [],
    description: "Ferienwohnung im 2. Obergeschoss mit Westbalkon. 70 m² für 2-4 Personen mit 2 Schlafzimmern, separater Küche und Panoramablick. Boxspringbetten 180x200cm, Smart-TV, Safe und alle modernen Annehmlichkeiten.",
    source: "https://www.beimlenzer.de/ferienwohnungen/fewo-saeuling",
  },
  {
    id: "branderschrofen",
    name: "Ferienwohnung \"Branderschrofen\"",
    short: "Sleeps 2-4 · 80 m² · South Balcony",
    pricePerNight: 130,
    pricePerNightLowSeason: 105,
    cleaningFee: 45,
    minNights: 3,
    maxGuests: 4,
    bedrooms: 2,
    sqm: 80,
    photos: [
      { src: "assets/branderschrofen/sitzecke.jpg", alt: "Branderschrofen – Gemütliche Sitzecke" },
      { src: "assets/branderschrofen/kueche.jpg", alt: "Branderschrofen – Wohnraum mit Küchenzeile" },
      { src: "assets/branderschrofen/schlafzimmer1.jpg", alt: "Branderschrofen – Schlafzimmer 1" },
      { src: "assets/branderschrofen/schlafzimmer2.jpg", alt: "Branderschrofen – Schlafzimmer 2" },
      { src: "assets/branderschrofen/badezimmer.jpg", alt: "Branderschrofen – Badezimmer mit separatem WC" },
      { src: "assets/branderschrofen/aussicht1.jpg", alt: "Branderschrofen – Aussicht vom Südbalkon" },
      { src: "assets/branderschrofen/aussicht2.jpg", alt: "Branderschrofen – Panoramablick" },
      { src: "assets/branderschrofen/aussicht3.jpg", alt: "Branderschrofen – Balkonaussicht" },
      { src: "assets/branderschrofen/haus.jpg", alt: "Branderschrofen – Außenansicht des Hauses" },
      { src: "assets/branderschrofen/grundriss.png", alt: "Branderschrofen – Grundriss" }
    ],
    blockedDates: [],
    description: "Ferienwohnung im 1. Obergeschoss mit Südbalkon. 80 m² für 2-4 Personen mit 2 Schlafzimmern, Dusche und separatem WC. Betten 200x200cm, Smart-TV, DVD-Player und herrlicher Panoramablick.",
    source: "https://www.beimlenzer.de/ferienwohnungen/fewo-branderschrofen",
  },
  {
    id: "geiselstein",
    name: "Ferienwohnung \"Geiselstein\"",
    short: "Sleeps 2-4 · 60 m² · South Balcony",
    pricePerNight: 110,
    pricePerNightLowSeason: 85,
    cleaningFee: 35,
    minNights: 3,
    maxGuests: 4,
    bedrooms: 2,
    sqm: 60,
    photos: [
      { src: "assets/geiselstein/wohnzimmer.jpg", alt: "Geiselstein – Wohnzimmer mit Smart-TV" },
      { src: "assets/geiselstein/wohnkueche.jpg", alt: "Geiselstein – Wohnzimmer mit Küchenzeile" },
      { src: "assets/geiselstein/schlafzimmer1.jpg", alt: "Geiselstein – Schlafzimmer 1 mit Boxspringbetten" },
      { src: "assets/geiselstein/schlafzimmer2.jpg", alt: "Geiselstein – Schlafzimmer 2" },
      { src: "assets/geiselstein/badezimmer.jpg", alt: "Geiselstein – Badezimmer mit Dusche/WC" },
      { src: "assets/geiselstein/aussicht.jpg", alt: "Geiselstein – Aussicht vom Südbalkon" },
      { src: "assets/geiselstein/grundriss.png", alt: "Geiselstein – Grundriss" }
    ],
    blockedDates: [],
    description: "Ferienwohnung im 1. Obergeschoss mit Südbalkon. 60 m² für 2-4 Personen mit 2 Schlafzimmern und Küchenzeile. Boxspringbetten 200x200cm, Smart-TV und Panoramablick auf die Berge.",
    source: "https://www.beimlenzer.de/ferienwohnungen/fewo-geiselstein",
  }
];

// Keep the original gallery-compatible structure but remove extra apartments
const ORIGINAL_APARTMENTS_BACKUP = [
  {
    id: "dorfstadel",
    name: "Dorfstadel",
